...
(
    ...
    [1] => Array
        (
            [id] => 2
            [active] => 1
            [theme] => Les qualifs de foot pour la France
			...
)

mkLiens($conversations,"theme","id","index.php?view=chat","idConv");

<a href="?champCible?"> ?LABEL? </a>
<a href="index.php?view=chat&idConv=1"> Le Web en EBM </a>
<a href="index.php?view=chat&idConv=2"> Les qualifs de foot pour la France </a>
*/
...
/*
mkLiens($tabData,$champLabel, $champCible, $urlBase=false, $nomCible="")
mkLiens($conversations,"theme","id","index.php?view=chat","idConv");

<a href="index.php?view=chat&idConv=1">Le Web en EBM</a>
<a href="index.php?view=chat&idConv=2">Les qualifs de foot pour la France</a>
<a href="index.php?view=chat&idConv=4">Nouvelle2</a>
*/
